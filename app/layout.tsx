...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="en"><body><a className="skip-link" href="#main">Skip to content</a><div className="shell"><Header/><main id="main">{children}</main><footer><div><Link className="wordmark" href="/">Paolo Narciso.</Link><p>Writing. Building. Connecting.</p></div><nav aria-label="Footer"><a href={site.subscribe}>Subscribe ↗</a><a href={site.linkedin}>LinkedIn ↗</a><a href={site.youtube}>YouTube ↗</a><Link href="/about">About</Link></nav><small>© {new Date().getFullYear()} Paolo Narciso</small></footer></div></body></html>}
